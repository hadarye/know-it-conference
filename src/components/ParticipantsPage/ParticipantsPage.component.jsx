...
const ParticipantsPage = () => {
    ...
    // },
    {
        ...
        "full-text": "מערך הלמידה והפיתוח הארגוני אמון על ההתפתחות האישית, ניהולית, מקצועית, והמחוברות של עובדי מכבי. אחד האמצעים המרכזיים להשגת המטרות הוא בנייה ופיתוח של קהילת שותפי למידה והפיכתם לכוח מקצועי, מכפיל כח של המערך. עובדים בתפקידים שונים: מובילי למידה, מדריכים פנימיים, מנטורים, מייקרים ויועצי קריירה המהווים זרוע נוספת שלנו ליצירת למידה עדכנית, רלבנטית וחדשנית."
    },
    {
        "img": aviv,
        "name": 'אביב ואנונו',
