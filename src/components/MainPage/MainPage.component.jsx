...
const MainPage = (props) => {
    ...
    const DATA = [
        ...
        'ענף הדרכה בקריית ההדרכה שבנגב מוביל את תחום ההדרכה בקריית ההדרכה, תוך פיתוח והטמעת שיטות ואמצעי הדרכה מתקדמים, מהווה מוקד ידע הדרכתי בתחומי פיתוח והערכת הדרכה. גם השנה אני גאים להזמין אתכם להתארח בכנס חדשני ומיוחד במינו.'
    ]
